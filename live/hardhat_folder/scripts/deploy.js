...
async function main() {
  ...
  const contractFactory = await hre.ethers.getContractFactory("ITGirl");
  ...
  console.log("ITGirl Contract deployed to:", contract.address);
  console.log("ITGirl Contract owner address:", owner.address);
}
